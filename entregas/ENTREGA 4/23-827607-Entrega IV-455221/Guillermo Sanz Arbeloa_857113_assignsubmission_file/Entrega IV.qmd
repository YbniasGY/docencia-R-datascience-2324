---
title: "Entrega IV"
author: "Guillermo Sanz - DNI: 12453961-J"
format:
  html:
    theme: [style.scss]
    toc: true
...
ggplot(nycflights13::flights) + 
  ...
  theme_minimal() +
  labs(x = "Month", y = "Number of Flights", title = "Diagrama de barras", caption = "Autor: Guillermo Sanz") +
...
ggplot(nycflights13::flights) + 
  ...
  theme(
    ...
    plot.caption = element_text(face = "italic", color = "yellow"),
...
ggplot(cruce, aes(x = name, y = retraso_medio)) +
  geom_bar(stat = "identity", aes(fill = retraso_medio)) +
  coord_flip() + # girar los ejes
  geom_hline(yintercept = media_global, color = "#17202A", ) +
  scale_fill_gradient2(low ="#58D68D" , high ="#CB4335" , mid = "#F9E79F", midpoint = 10) +
  theme_minimal() +
  labs(
    title = "Diagrama de barras",
    x = "Aerolíneas",
...
resultados <- datos |> 
  ...
  scale_fill_gradient2(low = "#A93226", high = "#2874A6",
